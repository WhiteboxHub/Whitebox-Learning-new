...
//       if (response.ok) {
//         setMessage(data); // Registration successful message
//       } else {
//         setMessage(data.error); // Error message from the server
//       }
//     } catch (error) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            ...
            {message && (
              <div className={`text-center text-sm mt-4 ${responseStatus === 'success' ? 'text-green-600' : 'text-red-600'}`}>
                {message}
              </div>
            )}
