...
export default function Cards() {
  return (
    <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
      {/* 1st testimonial */}
      <div
        className="flex flex-col h-100 p-6 bg-gray-800 rounded-2xl"
        data-aos="fade-up"
        data-aos-delay="400"
      >
        <div>
        ...
        <h1 className="text-2xl font-bold text-center">Fullstack Developer</h1>
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-center">Machine Learning</h1>
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-center">Data Engineering</h1>
