        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2 text-center">
                Online access using webinars
              </h4>
              <p className="text-lg text-gray-400 text-center">
                Gain convenient access to valuable knowledge through interactive
                webinars, empowering you to learn anytime, anywhere.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2 text-center">Portals for every course</h4>
              <p className="text-lg text-gray-400 text-center">
            ...
            >
              ...
              <h4 className="h4 mb-2 text-center">Online Recordings</h4>
              <p className="text-lg text-gray-400 text-center">
                Access our library of online recordings, ensuring you never miss
                a session and can review course material at your convenience.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2 text-center">
                Timed Quiz and Video Interviews
              </h4>
              <p className="text-lg text-gray-400 text-center">
